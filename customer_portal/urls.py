...
urlpatterns = [
    ...
    path('recovery/password_reset/',
        views.PasswordResetView.as_view(
            template_name='customer_portal/password_reset_form.html',
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(template_name='customer_portal/account/password_change_complete.html'),
