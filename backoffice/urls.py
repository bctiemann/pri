...
urlpatterns = [
    ...
    path('vehicles/<int:pk>/inspection/', views.VehicleInspectionView.as_view(), name='vehicle-inspection'),
    ...
    path('vehicles/type_<int:vehicle_type>/', views.VehicleListView.as_view(), name='vehicle-list'),
]
